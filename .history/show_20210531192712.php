      ...
      <div class="table-responsive">
       <table class="table table-sm table-bordered table-hover m-0">
         ...
         <?php
           ...
           $keyword = $_GET['search'];
           $result = mysqli_query($con, "SELECT * FROM data_mahasiswa WHERE nim LIKE '%".$keyword."%' OR nama LIKE '%".$keyword."%'");
           }else
           $result = mysqli_query($con, "SELECT * FROM data_mahasiswa ORDER BY nim ASC");
